-- TemaShop v7: acepta transferencia bancaria en República Dominicana ('transferencia_rd')
...
begin
  if p_payment_method not in ('cash_on_delivery', 'paypal', 'zelle', 'cashapp', 'transferencia_rd') then
